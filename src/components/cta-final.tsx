        ...
        <section className="py-16 bg-gradient-to-b from-slate-50 to-yellow-50">
            <div className="px-4 md:px-16 lg:px-24 xl:px-32">
                <div className="text-center">
                    <div className="bg-gradient-to-r from-yellow-500/30 to-yellow-500/40 rounded-2xl p-1 shadow-xl">
                    ...
                    <div className="flex items-center justify-center bg-white px-3 py-1.5 shadow gap-1 rounded-full text-xs">
                        ...
                        <span className="bg-gradient-to-r from-yellow-500 to-yellow-500 bg-clip-text text-transparent font-medium">Accès anticipé • Liste d’attente ouverte</span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-8">
                        <Link href="/signup">
                            <button 
                                type="button" 
                                className="bg-yellow-400 text-black text-sm px-8 py-3 rounded-xl font-medium hover:bg-yellow-500 hover:scale-105 active:scale-95 transition-all duration-300 shadow-lg hover:shadow-xl"
                            > 
                        ...
                        <Link href="#how-it-works">
                            <button 
                                type="button" 
                                className="bg-white text-yellow-600 border-2 border-yellow-500 text-sm px-8 py-3 rounded-xl font-medium hover:bg-yellow-500 hover:scale-105 active:scale-95 transition-all duration-300 shadow-lg hover:shadow-xl"
                            > 
                                Voir la démo
                            </button>
                        </Link>
